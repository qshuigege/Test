/*package cn.net.fusen.ssm.mybatispagination;
	...
	public class PageInterceptor implements Interceptor {
	    ...
	    *//**
	    ...
	    private String getPageSql(SearchPageUtil page, String sql) {
	        ...
	        if (PageInterceptor.MYSQL.equalsIgnoreCase(databaseType)) {
	            return getMysqlPageSql(page, sqlBuffer);
	        } else if (PageInterceptor.ORACLE.equalsIgnoreCase(databaseType)) {
