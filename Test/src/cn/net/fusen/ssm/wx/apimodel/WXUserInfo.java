package cn.net.fusen.ssm.wx.apimodel;
...
public class WXUserInfo {
	...
	public String toString() {
		return "WXAccount [openid=" + openid + ", unionid=" + unionid
				+ ", nickname=" + nickname + ", sex=" + sex + ", province="
				+ province + ", city=" + city + ", country=" + country
				+ ", headimgurl=" + headimgurl + ", createdate=" + createdate
				+ ", appid=" + appid + ", subscribe=" + subscribe
				+ ", language=" + language + ", subscribe_time="
				+ subscribe_time + ", remark=" + remark + ", groupid="
				+ groupid + ", tagid_list=" + Arrays.toString(tagid_list) + "]";
	}
